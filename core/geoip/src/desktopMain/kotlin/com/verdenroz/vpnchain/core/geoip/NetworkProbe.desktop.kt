...
actual fun createNetworkProbe(): NetworkProbe = JvmNetworkProbe()

internal class JvmNetworkProbe : NetworkProbe {
    ...
    override suspend fun samplePublicIp(): PublicIpSample? = withContext(Dispatchers.IO) {
        runCatching {
            ...
            // Force a fresh exchange; a cached response would time nothing at all.
